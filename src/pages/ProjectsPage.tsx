  ...
  return (
    <main className="min-h-screen bg-section-glow px-4 py-8 text-white md:px-8">
      <div className="mx-auto max-w-7xl">
        <div className="rounded-[2.3rem] border border-gold/18 bg-[linear-gradient(180deg,rgba(18,18,18,0.92),rgba(8,8,8,0.98))] p-7 shadow-panel md:p-10">
          <p className="text-xs uppercase tracking-[0.34em] text-gold/85">Project Directory</p>
          <div className="mt-4 flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-3xl">
              <h1 className="text-5xl leading-[0.92] text-sand md:text-7xl">All Projects</h1>
        ...
        <div className="mt-8 rounded-[2rem] border border-gold/14 bg-[linear-gradient(180deg,rgba(18,18,18,0.88),rgba(10,10,10,0.96))] p-5 shadow-panel md:p-6">
        ...
        <div className="mt-8 grid gap-5 lg:grid-cols-3">
          {filteredProperties.map((property, index) => (
            <motion.article
              ...
              className="overflow-hidden rounded-[1.9rem] border border-gold/14 bg-[linear-gradient(180deg,rgba(18,18,18,0.9),rgba(8,8,8,0.98))] shadow-panel"
            >
              ...
              <div className="p-5">
                ...
                <h2 className="mt-3 text-3xl text-sand">{property.title}</h2>
                ...
                <div className="mt-5 flex items-center justify-between gap-3">
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 rounded-full border border-gold/40 bg-gold/15 px-4 py-2 text-[11px] font-semibold uppercase tracking-[0.22em] text-gold transition hover:bg-gold/25"
                  >
                    View Details
                    <ArrowRight size={13} />
                  </Link>
